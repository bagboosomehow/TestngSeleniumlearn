...
public class SeleniumKeyTab {
    ...
    public void testAtesting() throws InterruptedException, IOException, InterruptedException {
        ...
        Thread.sleep(3000);
        System.out.println(webDriver.findElement(By.id("jq_psw")).getText());
        System.out.println(webDriver.findElement(By.id("jq_psw")).getSize());
        webDriver.findElement(By.id("jq_user")).clear();
        webDriver.findElement(By.id("jq_user")).sendKeys("13552076596");
        webDriver.findElement(By.id("jq_user")).sendKeys(Keys.TAB);
        Thread.sleep(3000);
