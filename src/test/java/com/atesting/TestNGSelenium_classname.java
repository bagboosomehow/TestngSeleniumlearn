 ...
 */
public class TestNGSelenium_classname {
    WebDriver webDriver;
    @BeforeMethod
    ...
    public void testAtesting() throws InterruptedException , IOException,InterruptedException {
        ...
        Thread.sleep(3000);
        webDriver.findElement(By.className("form-control input-lg")).sendKeys("atestingred");

        webDriver.findElement(By.className("form-control input-lg")).sendKeys("atestingred");
        webDriver.findElement(By.xpath("//button[contains(,.'登录')]")).click();
        Thread.sleep(5000);
